...
contract FlashloanTest is Test {
    ...
    function test_loopingSupply() public{
        ...
        //eksekusi looping sebesar supply 1WETH dan borrow 2350USDC
        flashloan.loopingSupply(1e18, 100e6);

        assertGt(IERC20(aWeth).balanceOf(address(flashloan)), 1e18);
        console.log("Balance of aWeth", IERC20(aWeth).balanceOf(address(flashloan)));
